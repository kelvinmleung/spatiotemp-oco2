...
#Load forward model 
numpy_model = np.load("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/linear_model_Wollongong2016.npy")
F_matrix = transpose(convert(Array{Float64}, numpy_model))

#Load true_x
numpy_true_x = np.load("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/true_state_vector_Wollongong2016.npy")
true_x = convert(Array{Float64}, numpy_true_x)

#Load error variance and make diagonal matrix
numpy_error_var = np.load("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/error_variance_Wollongong2016.npy")
...
numpy_prior_mean = np.load("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/prior_mean_Wollongong2016.npy")
prior_mean = convert(Array{Float64}, numpy_prior_mean)
numpy_prior_cov = np.load("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/prior_cov_matrix_Wollongong2016.npy")
prior_cov_matrix = convert(Array{Float64}, numpy_prior_cov)

#Load weighting function
numpy_h = np.load("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/weighting_func_Wollongong2016.npy")
...
if isfile("sample_error_Wollongong2016.jls")
    # Load sample_error from the file
    sample_error = open(deserialize, "sample_error_Wollongong2016.jls")
else
    # Generate new sample_error if the file doesn't exist
    sample_error = rand(error_dist)
    
    # Save sample_error to a file
    open("sample_error_Wollongong2016.jls", "w") do io
