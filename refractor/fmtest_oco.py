...
#sys.path.append('/home/jhobbs/Refractor/oco')
#
#print(os.en)
#os.environ['PYTHONPATH'].append('/home/jhobbs/Refractor/oco/config')
print(os.environ['OCO_CONFIG_DIR'])
...
# On OCO systems:
#l1b_dir = os.path.realpath('/data/oco2/ops/product/Ops_B10003_r02/2015/08/08/L1bSc')
#l1b_file = os.path.join(l1b_dir, "oco2_L1bScND_05862a_150808_B10003r_191117045059.h5")
#met_dir = os.path.realpath('/data/oco2/ops/product/Ops_B10003_r02/2015/08/08/L2Met')
#met_file = os.path.join(met_dir, "oco2_L2MetND_05862a_150808_B10003r_191117035013.h5")
