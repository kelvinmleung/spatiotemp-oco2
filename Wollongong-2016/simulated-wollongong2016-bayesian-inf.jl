...
#Load true_x
numpy_true_x = np.load("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/Wollongong-2016/true_state_vector_Wollongong2016.npy")
true_x = convert(Array{Float64}, numpy_true_x)

#Load error variance and make diagonal matrix
numpy_error_var = np.load("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/Wollongong-2016/error_variance_Wollongong2016.npy")
...
numpy_prior_mean = np.load("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/Wollongong-2016/prior_mean_Wollongong2016.npy")
prior_mean = convert(Array{Float64}, numpy_prior_mean)
numpy_prior_cov = np.load("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/Wollongong-2016/prior_cov_matrix_Wollongong2016.npy")
prior_cov_matrix = convert(Array{Float64}, numpy_prior_cov)

#Load weighting function
numpy_h = np.load("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/Wollongong-2016/weighting_func_Wollongong2016.npy")
...
if isfile("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/Wollongong-2016/sample_error_Wollongong2016.jls")
    # Load sample_error from the file
    sample_error = open(deserialize, "/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/Wollongong-2016/sample_error_Wollongong2016.jls")
else
    # Generate new sample_error if the file doesn't exist
    sample_error = rand(error_dist)
    
    # Save sample_error to a file
    open("/Users/Camila/Desktop/OCO-2_UROP/spatiotemp-oco2/Wollongong-2016/sample_error_Wollongong2016.jls", "w") do io
...
savefig(objective_plot, joinpath(save_dir, "Wollongong2016-NegLogPosterior-vs-Iterations.png"))
savefig(gradient_plot, joinpath(save_dir, "Wollongong2016-Gradient-vs-Iterations.png"))
...
savefig(col_avg_plot, joinpath(save_dir, "Wollongong2016-ColAvgCO2.png"))
...
vertical_profile = plot_vertical_profile(map_estimate,prior_mean, "Wollongong 2016", true_map, true_x)
display(vertical_profile)
savefig(vertical_profile, joinpath(save_dir, "Wollongong2016-Ver