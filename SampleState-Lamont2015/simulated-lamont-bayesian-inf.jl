...
savefig(objective_plot, joinpath(save_dir, "Lamont2015-NegLogPosterior-vs-Iterations.png"))
savefig(gradient_plot, joinpath(save_dir, "Lamont2015-Gradient-vs-Iterations.png"))
...
savefig(col_avg_plot, joinpath(save_dir, "Lamont2015-ColAvgCO2.png"))
